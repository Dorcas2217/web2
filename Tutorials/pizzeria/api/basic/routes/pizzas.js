...
router.delete('/:id', (req, res) => {
  ...
  // le splice suppime un elt du tableau et renvoie l'objet supprimé sous forme d'une array
  // comme içi on supprime uniqm 1seul elt, il est donc à l'indice 0 de l'elt à renvoyer
