...
// pourquoi lorsque j'enlève içi la musique joue toujours lorsqu'on clique
...
function renderMenuFromString(menu) {
  ...
  main.innerHTML += menuTableAsString; // pour ne pas écraser le main déjà présent!!
}
...
// le table dans le querySelector sort d'où ? il n'est pas dans le Html
